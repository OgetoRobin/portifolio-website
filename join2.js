    ...
    form.addEventListener("submit", function (e) {
        ...
        .then(function (response) {
            ...
            setTimeout(function () {
                ...
                const successMsg = `Dear ${name}, 🎉 Welcome Aboard!,your Details have been received! Please check your email${email} for confirmation.🚧 Note: Saa hii site iko kwa testing kidogo, so ukiona vitu ziko tofauti ama kuna ka-issue hapa na pale, usishtuke 😄 tunaboresha experience yako..`;
